...
<html>
    ...
    echo htmlspecialchars($_POST["username"], ENT_QUOTES);
                ...
                <br>
                <label for="password">パスワード</label><input type="password" id="password" name="password" placeholder="パスワードを入力" value="<?php if (!empty($_POST["password"])) {
    echo htmlspecialchars($_POST["password"], ENT_QUOTES);
} ?>">
                <br>
                <label for="password2">パスワード(確認用)</label><input type="password" id="password2" name="password2" placeholder="再度パスワードを入力" value="<?php if (!empty($_POST["password2"])) {
